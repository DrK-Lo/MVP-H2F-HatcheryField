...
```
    ...
    ## [1,] "28.0841" "-97.2009" "2007"    "2021"    "23.1060500319357"       
    ##      Mean_max_temperature_C Mean_min_temperature_C Temperature_st_dev
    ## [1,] "32.61875"             "7.775"                "6.38548669115223"
    ##      high_temp_stress_days frac_high_temp_stress_days Temperature_n
    ## [1,] "1839"                "0.357226107226107"        "490047"     
...
write.table(W1_TX_temp, "/Users/madelineeppley/GitHub/MVP-H2F-HatcheryField/data/environment/seascape_temperature.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame
...
``` r
# Write to the combined file with all sites 
write.table(W1_TX_salinity, "/Users/madelineeppley/GitHub/MVP-H2F-HatcheryField/data/environment/seascape_salinity.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame
