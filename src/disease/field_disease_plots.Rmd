---
title: "Dermo_MSX_Field_H2F"
author: "Nicole Mongillo & Camille Rumberger"
date: "2026-02-13"
output: pdf_document
---

This code is based on code produced by Madeline Eppley in H2Fdisease_barplots.R NM edited their code to create a plot of RFTM results for Dermo prevalence in Lewisetta and York River that matches H2F plot formatting. CR added MSX prevalence.
...
## Load data
```{r}
dermo_york <- read.csv("data/disease/H2F_dermo_york_RFTM.csv")
dermo_lew <- read.csv("data/disease/H2F_lewisetta_dermo.csv")
dis_yrk <- read.csv("data/disease/H2F_prev_york_bothdiseases.csv")
```
...
ggsave("figures/disease/Fig2A_dermo_field_H2F.pdf",
       plot = dermo_H2F,
       device = "pdf",
       height = 3,
       width = 5,
...
ggsave("figures/disease/Fig2B_MSX_field_H2F.pdf",
       plot = msx_H2F,
       device = "pdf",
       height = 3,
       width = 5,
