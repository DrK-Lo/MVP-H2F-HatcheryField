...
MGE wrote this code. Code was adapted by NM to format figures for H2F. 

```{r}
pca_data <- read.csv("../../data/parental_genetics_structure/20250604_pca_data_exp.csv")
...
map_with_sites <- base_map + 
  geom_scatterpie(
    ...
    cols = c("Q2_avg", "Q1_avg"), 
    color = NA,
    pie_scale = 1.5) +  
  scale_fill_manual(name = "Genetic cluster", breaks = c("Q2_avg", "Q1_avg"), labels = c("Gulf", "Atlantic"), values = c("#1565C0", "#81C784")) +  
  theme(
