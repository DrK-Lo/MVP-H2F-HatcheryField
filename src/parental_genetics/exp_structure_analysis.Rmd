...
MGE wrote this code in "exp_structure_analysis.R." Code was adapted by NM to format figures for H2F. 
...
inset_map <- inset_base +
  ...
  scale_fill_manual(name = " ", breaks = c("LEW", "YRK"), 
                    ...
                    labels = str_wrap(c("Lewisetta (LEW): low salinity and disease, LOLA selection site", "York (YRK): higher salinity and disease, DEBY selection site"), width = 35))+
