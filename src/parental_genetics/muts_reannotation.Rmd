...
packages <- c("here", "readr", "dplyr", "purrr", "tidyverse", "rtracklayer", "GenomicRanges", "biomaRt")
...
# this collapses the data frame into one row per SNP
...
write_csv(
  ...
  file.path("supp_files", "all_SNPs_reannotated.csv")
)
...
snp_reloaded <- read_csv(file.path("supp_files", "all_SNPs_reannotated.csv")) %>%
  mutate(
