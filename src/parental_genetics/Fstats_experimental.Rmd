...
packages <- c("here", "ggplot2", "hierfstat", "reshape2", "dplyr", "tidyr", "readr", "adegenet", "viridis", "OutFLANK", "purrr")
...
write_csv(parent_genetic_effects, file.path("results", "parent_effects_H2F", "parent_genetic_effects.csv"))
