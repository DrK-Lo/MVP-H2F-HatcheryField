...
full_set <- readRDS(file.path("..", "..", "data", "parental_genetics_structure", "20250604_experimentalmatrix.rds"))



# SNP set thinned for LD
thinned_snps <- readRDS(file.path("..", "..", "data", "parental_genetics_structure", "20250604_THINNEDSNPs_exp.rds"))

# full SNP set 
full_snps <- readRDS(file.path("..", "..", "data", "parental_genetics_structure", "20250604_FULLSNPs_exp.rds"))
