...
knitr::opts_knit$set(root.dir = "~/Desktop/GitHub/MVP-H2F-HatcheryField/src")
...
# add pop to df
merge4$pop <- str_split_fixed(merge4$bags_label, "-", 3)[,2]
...
# calc survival
e1_surv <- surv_calc_bag(merge4, 1)
e2_surv <- surv_calc_bag(merge4, 2)
e3_surv <- surv_calc_bag(merge4, 3)

# long format df
surv_long <- rbind(e1_surv,e2_surv,e3_surv)

# save long format bag-level survival
colnames(surv_long) <- c("bags_label", "event", "surv")
write.csv(surv_long, "../../data/performance_H2F/mortality_long_bags.csv")
...
#write.csv(mort_df, "../../data/performance_H2F/mortality_long_popsite_h2f.csv")
#write.csv(surv_df_ord, "../../data/performance_H2F/mortality_bags_h2f.csv")
```
