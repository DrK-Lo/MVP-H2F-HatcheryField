...
write.csv(tagsbags6, "data/lengths_long.csv")
```
...
# save it
write.csv(lengths_bags_df, "data/performance_H2F/lengths_bags_022025.csv")
...
sink("results/performance_H2F/len_sites_02202025.txt")
york1
york2
york3
lew1
