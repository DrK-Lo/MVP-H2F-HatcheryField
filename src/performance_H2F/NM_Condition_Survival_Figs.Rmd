...
This creates box plots of the condition index by population, with unique colors for LEW and YR. 
```{r}
...
field_ci <- ggplot(data202411, aes(x = population, y = CI, fill = site)) +
  ...
  scale_x_discrete() +  
  labs(x = "Parental Group", y = "Condition Index", title = "Condition Index vs. Parental Group", subtitle = "Final Field Time Point", fill = "Site") +   scale_fill_manual(labels = c("LEW" = "Lewisetta", "YR" = "York River"), values = c("LEW" = "#F06292", "YR" = "#880E4F")) +  
  theme_minimal() +
  theme_bw()+
...
field_ci_sig <- field_ci + 
  geom_segment(data = a_df, aes(x = x1, xend = x2, y = 8, yend =8)) + 
  geom_segment(data = b_df, aes(x = x1, xend = x2, y = 7.8, yend = 7.8))+
  geom_segment(data = c_df, aes(x = x1, xend = x2, y = 7.6, yend =7.6))+
  geom_segment(data = d_df, aes(x = x1, xend = x2, y = 7.4, yend =7.4))+
  geom_segment(data = e_df, aes(x = x1, xend = x2, y = 7.2, yend =7.2))+
  geom_segment(data = f_df, aes(x = x1, xend = x2, y = 7, yend =7))
...
surv_t3_plot <- ggplot(survival, aes(x = population, y = survival, fill = site)) + 
  ...
  ggtitle("Survival vs Parental Group") +
  scale_x_discrete() +  
  ylim(c(0, 1.3))+
  labs(x = "Parental Group", y = "Survival", subtitle = "Final Field Time Point", fill = "Site") +   scale_fill_manual(values = c("Lewisetta" = "#F06292", "YorkRiver" = "#880E4F"), labels = c("Lewisetta" = "Lewisetta", "YorkRiver" = "York River")) + 
  theme_bw()+
  theme(axis.text.x = element_text(angle = 45, hjust = 1, color = "black", size = 10),
        axis.title = element_text(size = 12),
        axis.text.y = element_text(color = "black", size = 10),
...
surv_t3_plot_sig <- surv_t3_plot + 
  geom_segment(data = a_s_df, aes(x = x1, xend = x2, y = 1.24, yend =1.24)) + 
  geom_segment(data = b_s_df, aes(x = x1, xend = x2, y = 1.21, yend = 1.21))+
  geom_segment(data = c_s_df, aes(x = x1, xend = x2, y = 1.18, yend =1.18))+
  geom_segment(data = d_s_df, aes(x = x1, xend = x2, y = 1.15, yend =1.15))+
  geom_segment(data = e_s_df, aes(x = x1, xend = x2, y = 1.12, yend =1.12))+
  geom_segment(data = f_s_df, aes(x = x1, xend = x2, y = 1.09, yend =1.09)) +
  geom_segment(data = g_s_df, aes(x = x1, xend = x2, y = 1.06, yend =1.06))+
  geom_segment(data = h_s_df, aes(x = x1, xend = x2, y = 1.03, yend =1.03))+
  geom_segment(data = i_s_df, aes(x = x1, xend = x2, y = 1, yend =1))
...
len_plot <- ggplot(length, aes(x = pop, y = length, fill = bag_site)) + 
  ...
  ylim(c(0, 134))+
  labs(x = "Parental Group", y = "Length (mm)", title = "Shell Length vs. Parental Group", subtitle = "Final Field Time Point", fill = "Site")+
...
len_plot_sig <- len_plot + 
  geom_segment(data = a_l_df, aes(x = x1, xend = x2, y = 132, yend =132)) + 
  geom_segment(data = b_l_df, aes(x = x1, xend = x2, y = 130, yend = 130))+
  geom_segment(data = c_l_df, aes(x = x1, xend = x2, y = 128, yend =128))+
  geom_segment(data = d_l_df, aes(x = x1, xend = x2, y = 126, yend =126))+
  geom_segment(data = e_l_df, aes(x = x1, xend = x2, y = 124, yend =124))+
  geom_segment(data = f_l_df, aes(x = x1, xend = x2, y = 122, yend =122)) +
  geom_segment(data = g_l_df, aes(x = x1, xend = x2, y = 120, yend =120))+
  geom_segment(data = h_l_df, aes(x = x1, xend = x2, y = 118, yend =118))+
  geom_segment(data = i_l_df, aes(x = x1, xend = x2, y = 116, yend =116))+
  geom_segment(data = j_l_df, aes(x = x1, xend = x2, y = 114, yend =114))
