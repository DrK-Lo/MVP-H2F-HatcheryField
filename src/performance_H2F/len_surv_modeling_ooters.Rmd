...
lmm4 <- lm(surv ~ bag_site * pop * t, data = surv_mod_ord_rename) # no bags label
#plot(lmm4)
Anova(lmm4, type = "III")
drop1(lmm4)
# could drop three way interaction, this is Satterwaithe's method
lmm4.1 <- lm(surv ~ bag_site * pop * t - bag_site:pop:t, data = surv_mod_ord_rename) # no bags label
...
lmm5 <- lm(surv ~ bag_site * pop, data = surv_mod_ord_rename[surv_mod_ord_rename$t == 3,])
#plot(lmm5)
...
sink("../../results_field/survival_model_results_03142025.txt")
Anova(lmm4.1, type = "III")
Anova(lmm5, type = "III")
sink()
...
sink("../../results_field/survival_model_results_03282025.txt")
Anova(lmm4.1, type = "III")
Anova(lmm5, type = "III")
...
(pairwise_contrasts_lmm10 <- emmeans(lmm10, ~ bag_site * pop) )
...
write.csv(letters_len_t3_df, "../../data/performance_H2F/field_length_letters.csv")
