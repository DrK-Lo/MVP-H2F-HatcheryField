...
survival <- read.csv("../../data/performance_H2F/field_surv_final_time2026-01-03.csv")[,-c(1, 8)]
...
```{r}
length <- read.csv("../../data/performance_H2F/field_length_final_time_2026-01-03.csv")[, 2:10]
