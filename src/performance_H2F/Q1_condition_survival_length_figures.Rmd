...
field_ci <- ggplot(data202411, aes(x = population, y = CI, fill = site)) +
  ...
  scale_x_discrete() +  
  labs(x = "Treatment Group", y = "Condition Index", title = "Condition Index vs. Treatment Group", subtitle = "Final Field Monitoring Event, Nov. 2024", fill = "Site") +   scale_fill_manual(labels = c("LEW" = "Lewisetta", "YR" = "York River"), values = c("LEW" = "#F06292", "YR" = "#880E4F")) +  
  ylim(c(0, 12.2))+
  theme_minimal() +
  theme_classic()+
