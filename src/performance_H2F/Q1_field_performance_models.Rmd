...
sink(paste0("../../results/performance_H2F/survival_model_results_",Sys.Date(),".txt"))
...
lengths <- read.csv("../../data/performance_H2F/lengths_long.csv")[,-1]
head(lengths)
...
# save all this 
sink(paste0("results/performance_H2F/length_model_results_",Sys.Date(),".txt"))
Anova(lmm3, type = "III")
Anova(lmm4, type = "III")
anova_len_t3
letters_len_t3
...
write.csv(letters_len_t3_df, paste0("results/performance_H2F/field_length_letters_",Sys.Date(),".csv"))
