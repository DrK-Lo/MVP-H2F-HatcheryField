...
```{r}
#setwd("~/Desktop/GitHub/MVP-H2F-HatcheryField")
# read in data
surv_long <- read.csv("../../data/performance_H2F/mortality_long_bags.csv")[,-1]
...
write.csv(surv_mod_ord_rename, "../../data/performance_H2F/field_surv_all_times.csv")
...
lengths <- read.csv("../../data/performance_H2F/lengths_long")[,-1]
head(lengths)
...
# we should remove seedmix and larmix from the df used to test for parental effects since we have no environmental data for these
...
write.csv(lengths_mod_narm_nodead, "../../data/performance_H2F/field_length_all_times_.csv")
```
...
# save everything
#sink(paste0("../../results/performance_H2F/survival_GE_model_results_",Sys.Date(),".txt"))
cat("\nLEWt1 quants\n")
...
#sink(paste0("../../results/performance_H2F/len_GE_model_results_",Sys.Date(),".txt"))
cat("\nLEWt1 quants\n")
