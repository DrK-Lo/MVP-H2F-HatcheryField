...
260716: KEB: these models are run with the juvenile heterozygosity and allelic richness data which is calculated correctly.
...
juv_genetics <- read.csv("results/parent_effects_H2F/juvenile_genetic_effects_thinned.csv")
