...
# lengths of all oysters averaged by bag for field monitoring events 1-3 #GET RIGHT FILE
field_length <- read.csv(file.path("data", "performance_H2F", "lengths_bags.csv"))

# survival of all oysters averaged by bag for field monitoring events 1-3 #GET RIGHT FILE
field_survival <- read.csv(file.path("data", "performance_H2F", "mortality_long_bags.csv"))
