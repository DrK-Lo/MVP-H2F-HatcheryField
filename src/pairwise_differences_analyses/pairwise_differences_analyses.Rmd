...
envr_summary <-  read.csv(file.path("..", "..", "results", "envr_of_origin", "envr_quantiles_summary.csv"))

# matrix of euclidean environmental distances using SCALED data
envr_dist <- readRDS(file.path("..", "..", "results", "envr_of_origin", "envr_quantiles_dist.rds"))
...
ggsave(file.path("..", "..", "figures", "pairwise_differences_analyses", "fig_fst_heatmap.pdf"), heatmap_fst, width = 12, height = 10)
ggsave(file.path("..", "..", "figures", "pairwise_differences_analyses", "fig_envr_dist_heatmap.pdf"), heatmap_envr, width = 12, height = 10)
