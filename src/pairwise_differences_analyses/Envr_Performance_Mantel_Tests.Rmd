...
*** See below for partial Mantel code *** - Kiran
...
envr_summary <-  read.csv(file.path("..", "..", "data", "envr_of_origin", "envr_for_violinplots.csv"))

#this file is a matrix of the environmental distances between each group
envr_dist <- read.csv(file.path("..", "..", "data", "envr_of_origin", "envr_dist.csv"))
