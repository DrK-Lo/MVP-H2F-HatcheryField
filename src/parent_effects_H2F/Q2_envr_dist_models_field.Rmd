...
text_col <- ifelse(abs(cor_matrix_lew) > 0.5, "white", "black")
...
text_col <- ifelse(abs(cor_matrix_yrk) > 0.5, "white", "black")
...
#write.csv(surv_resid_dist, "../../data/performance_H2F/residuals_distance_vs_surv.csv", row.names = F)
```
...
# save residuals as well for supp fig
#write.csv(len_dist_resid, "../../data/performance_H2F/residuals_distance_vs_length.csv", row.names = F)
```
