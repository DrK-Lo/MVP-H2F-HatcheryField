---
title: "envrdist_residuals_plots"
...
resid_surv <- read.csv("results/performance_H2F/residuals_distance_vs_surv.csv")
resid_len <- read.csv("results/performance_H2F/residuals_distance_vs_length.csv")
```
...
plots <- list(
  "lew_length_envrdist_residuals_t1" = lew_surv1,
  "lew_length_envrdist_residuals_t2" = lew_surv2,
  "FigS9B_lew_length_envrdist_residuals_t3" = lew_surv3,
  "york_length_envrdist_residuals_t1" = yrk_surv1,
  "york_length_envrdist_residuals_t2" = yrk_surv2,
  "FigS9D_york_length_envrdist_residuals_t3" = yrk_surv3
)
