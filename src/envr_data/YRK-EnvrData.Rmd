...
#Since the field experiment was 2023 and 2024 those are the years we're using here.
...
#save cleaned sal and temp data into separate csv files. First, add column for site_name
YRK_name <- YRK
YRK_name$site_name <- c("YRK")

#write.csv(YRK_name[, c("site_name", "datetime", "temp")], "data/envr_of_origin/full_temp/YRK_temp_full.csv")
#write.csv(YRK_name[, c("site_name", "datetime", "salinity")], "data/envr_of_origin/full_sal/YRK_sal_full.csv")
```
...
write.csv(YRK_temp, "data/environment/York-River/YRK_temperature.csv")

# Write all montly data to a unique new CSV file
write.csv(YRK_monthly_temp, "data/environment/York-River/YRK_monthly_temp.csv")
...
write.csv(YRK_salinity, "data/environment/York-River/YRK_salinity.csv")
# Write all montly data to a unique new CSV file
write.csv(YRK_monthly_sal, "data/environment/York-River/YRK_monthly_sal.csv")
```
