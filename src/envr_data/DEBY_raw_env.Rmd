...
First, set working directory to Rmd file location by clicking "Session" --> "Set Working Directory --> "To Source File Location"
...
setwd("/Users/nicolemongillo/Desktop/GitHub/MVP_Chesapeake_VIMS_hatchery/data/envr_raw_data/DEBY_York_")

#merge files into one
raw_DEBY_env <- list.files(path="../../data/envr_of_origin/DEBY_York_Raw_Yearly") %>% 
  lapply(read.csv) %>% 
  bind_rows 
