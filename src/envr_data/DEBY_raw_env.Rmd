...
setwd("/Users/nicolemongillo/Desktop/GitHub/MVP_Chesapeake_VIMS_hatchery/data/envr_raw_data/DEBY_York")

#merge files into one
raw_DEBY_env <- list.files(path="/Users/nicolemongillo/Desktop/GitHub/MVP_Chesapeake_VIMS_hatchery/data/envr_raw_data/DEBY_York") %>% 
  lapply(read.csv) %>% 
  bind_rows 
