...
W5_NH <- W5_NH[, c(6, 1, 2, 3, 4, 5)]

W5_NH_temp_full <-W5_NH[, c(1,2,3,5)]

W5_NH_sal_full <- W5_NH[, c(1,2,4,6)]

#save W4_VA as csv for future analyses
write.csv(W5_NH_temp_full, "data/envr_of_origin/full_temp/W5_NH_temp_full.csv", row.names = FALSE)

write.csv(W5_NH_sal_full, "data/envr_of_origin/full_sal/W5_NH_sal_full.csv", row.names = FALSE)
```
...
write.table(W5_NH_temp, "data/environment/all_temperature.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame

# Write to a unique new CSV file
write.csv(W5_NH_temp, "data/environment/W5-NH/W5-NH_temperature.csv")

# Write all monthly data to a unique new CSV file
write.csv(W5_NH_monthly_temp, "data/environment/W5-NH/W5-NH_monthly_temp.csv")
...
# Write to the combined file with all sites 
write.table(W5_NH_salinity, "data/environment/all_salinity.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame

# Write all year data to a unique new CSV file
write.csv(W5_NH_salinity, "data/environment/W5-NH/W5-NH_salinity.csv")
# Write all montly data to a unique new CSV file
write.csv(W5_NH_monthly_sal, "data/environment/W5-NH/W5-NH_monthly_sal.csv")
