...
envr_quants_raw <- read_csv(file.path("..", "..", "data", "environment", "quantiles_11092025.csv"),
  ...
  dplyr::select(-1, -9)  # remove index and unused columns
...
write.csv(envr_origin, file.path("..", "..", "results", "environment", "envr_quantiles_summary.csv"),
          row.names = FALSE)
```
...
write.csv(envr_dist_all, file.path("..", "..", "results", "environment", "envr_quantiles_dist_all.csv"))

# distance matrix for environment-of-origin sites sites only for downstream analysis
saveRDS(envr_dist_origin, file.path("..", "..", "results", "environment", "envr_quantiles_dist.rds"))
