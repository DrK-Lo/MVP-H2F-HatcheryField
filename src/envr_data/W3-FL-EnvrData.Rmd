...
W3_FL_temp_full <- W3_FL_temp %>% 
  mutate(site_name = "W3_FL")

#make temp df
W3_FL_temp_full <- W3_FL_temp_full %>% 
  select(site_name, Timestamp, temp) %>%
...
W3_FL_sal_full <- W3_FL_sal_full %>% 
  select(site_name, Timestamp, salinity) %>%
  rename(datetime = Timestamp)

#save W3_FL as csv for future analyses
write.csv(W3_FL_temp_full, "data/envr_of_origin/full_temp/W3_FL_temp_full.csv", row.names = FALSE)

write.csv(W3_FL_sal_full, "data/envr_of_origin/full_sal/W3_FL_sal_full.csv", row.names = FALSE)
```
...
write.table(W3_FL_temp, "data/environment/all_temperature.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame

# Write to a unique new CSV file
write.csv(W3_FL_temp, "data/environment/W3-FL/W3-FL_temperature.csv")

# Write all montly data to a unique new CSV file
write.csv(W3_FL_monthly_temp, "data/environment/W3-FL/W3-FL_monthly_temp.csv")
...
# Write to the combined file with all sites 
write.table(W3_FL_salinity, "data/environment/all_salinity.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame

# Write all year data to a unique new CSV file
write.csv(W3_FL_salinity, "data/environment/W3-FL/W3-FL_salinity.csv")
# Write all montly data to a unique new CSV file
write.csv(W3_FL_monthly_sal, "data/environment/W3-FL/W3-FL_monthly_sal.csv")
