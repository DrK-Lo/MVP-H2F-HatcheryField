---
title: "VA_corrections"
author: "Nicole Mongillo"
output: pdf_document
date: "2024-10-15"
---

This code examines the differences between environmental data sources for the VA site, located at Deep Water Shoal, James River, Virginia, as part of the MVP H2F project. The two data sources are:

1. VIMS Water Quality Data, which were downloaded by Madeline Eppley on 15 September 2023
2. NOAA National Buoy Data Center (NDBC), Chesapeake Bay Interpretive Buoy System downloaded by Nicole Mongillo on 1 October 2024. 

This code plots the salinity and temperature data from each data set against each other to see how similar the data are, then applies a correction factor to the NDBC data based on the difference between NDBC and VIMS data. 

All labels for objects with data from NOAA begin with NDBC, and all labels for objects with data from VIMS are labeled VIMS.

**KEB update 260305: There was a lot of repetitive code associated with this analysis. The only code now used for W4-VA environmental data analysis is this file (VA_corrections.Rmd) and W4-VA-EnvrData.Rmd. 
...
#Source - Missy Southworth, VIMS Annual Summer Environmental Data Collection, https://www.vims.edu/research/units/labgroups/molluscan_ecology/publications/
