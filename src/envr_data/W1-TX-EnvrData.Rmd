...
tart with the date and time of collection. We will use the lubridate package to standardize all values into the date-time format called POSIXct. This format stores the date and time in number of seconds since a past point (1/1/1970). This makes comparisons easy and helps to standardizes values. 
...
write.table(W1_TX_temp, "data/environment/all_temperature.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame

# Write to a unique new CSV file
write.csv(W1_TX_temp, "data/environment/W1-TX/W1-TX_temperature.csv")

# Write all monthly data to a unique new CSV file
write.csv(W1_TX_monthly_temp, "data/environment/W1-TX/W1-TX_monthly_temp.csv")
...
# Write to the combined file with all sites 
write.table(W1_TX_salinity, "data/environment/all_salinity.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame

# Write all year data to a unique new CSV file
write.csv(W1_TX_salinity, "data/environment/W1-TX/W1-TX_salinity.csv")
# Write all montly data to a unique new CSV file
write.csv(W1_TX_monthly_sal, "data/environment/W1-TX/W1-TX_monthly_sal.csv")
