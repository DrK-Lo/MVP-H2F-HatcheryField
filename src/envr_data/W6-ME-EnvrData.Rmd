...
write.table(W6_ME_temp, "data/environment/all_temperature.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame

# Write to a unique new CSV file
write.csv(W6_ME_temp, "data/environment/W6-ME/W6-ME_temperature.csv")

# Write all monthly data to a unique new CSV file
write.csv(W6_ME_monthly_temp, "data/environment/W6-ME/W6-ME_monthly_temp.csv")
...
# Write to the combined file with all sites 
write.table(W6_ME_salinity, "data/environment/all_salinity.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame

# Write all year data to a unique new CSV file
write.csv(W6_ME_salinity, "data/environment/W6-ME/W6-ME_salinity.csv")
# Write all montly data to a unique new CSV file
write.csv(W6_ME_monthly_sal, "data/environment/W6-ME/W6-ME_monthly_sal.csv")
