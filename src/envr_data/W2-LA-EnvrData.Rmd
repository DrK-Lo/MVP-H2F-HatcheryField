...
```{r}
write.table(W2_LA, "data/environment/W2-LA/W2-LA-raw.csv", sep = ",", append = TRUE, col.names = TRUE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame
```
...
write.table(W2_LA_temp, "data/environment/all_temperature.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame

# Write to a unique new CSV file
write.csv(W2_LA_temp, "data/environment/W2-LA/W2-LA_temperature.csv")

# Write all monthly data to a unique new CSV file
write.csv(W2_LA_monthly_temp, "data/environment/W2-LA/W2-LA_monthly_temp.csv")
...
# Write to the combined file with all sites 
write.table(W2_LA_salinity, "data/environment/all_salinity.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame

# Write all year data to a unique new CSV file
write.csv(W2_LA_salinity, "data/environment/W2-LA/W2-LA_salinity.csv")
# Write all montly data to a unique new CSV file
write.csv(W2_LA_monthly_sal, "data/environment/W2-LA/W2-LA_monthly_sal.csv")
