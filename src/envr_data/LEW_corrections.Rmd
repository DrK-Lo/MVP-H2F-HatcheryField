---
title: "LEW_corrections"
author: "Nicole Mongillo and Camille Rumberger"
output: pdf_document
date: "2025-11-05"
---

This code examines the differences between environmental data for the LOLA/Lewisetta sites, located in the 
Coan River, Virginia, as part of the MVP H2F project. The data sources are:
...
```{r NDBC}
# directory for files
lew_sonde <- "data/environment/Lewisetta/lew_raw/lew_sonde" 
pot_sonde <- "data/environment/Lewisetta/lew_raw/potomac_sonde"
...
```{r VIMS_cleaning}
# read in data
lew <- read.csv("data/environment/Lewisetta/lew_raw/lewisetta_coandat.csv")[,-1]
...
# VIMS data (from Willy Reay) is 0.09287575ºC above NOAA data, apply this correction to past NOAA data (2014-2020)

sal_correction <- mean(lew_mg$sal_diff)
# VIMS data (from Willy Reay) is -1.192284 below NOAA data, apply this correction to past NOAA data (2014-2020)
...
write.csv(lew_correct, "data/environment/Lewisetta/lewisetta_corrected.csv", row.names = F)
