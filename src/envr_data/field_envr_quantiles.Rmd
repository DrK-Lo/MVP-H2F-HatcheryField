...
This file compiles salinity data from all environment-of-origin sites
and common garden field sites, computes temperature and salinity quantile
summaries, and produces visualization panels (violin plots and heatmaps) for
Figure 1 of H2F. It also creates disease pressure heatmaps for Dermo and MSX at
each site. The main data product is `envr_quantiles_allsites.csv`, which is
used by downstream modeling scripts (Q2_envr_quantile_models_field.Rmd,
Q2_condition_index_models_field.Rmd, Q2_models_hatchery_nursery.Rmd).
