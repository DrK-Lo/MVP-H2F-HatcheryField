...
LOLA_sal <- read.csv("data/envr_of_origin/full_sal/LOLA_sal_full.csv")[, c(2,3)]
#add site_name column
LOLA_sal$site_name <- "LOLA"
...
LOLA_sal$datetime <- as.POSIXct(LOLA_sal$datetime, "%Y-%m-%d", tz = "")
...
summary(na_full_sal) # we have 190 NAs in datetime and 192110 NAs in salinity that are stored as "TRUE" 
...
#write to csv
write.csv(quantiles, file = "results/environment/envr_quantiles_allsites.csv")
...
# ggsave("field_sal10_heatmap.pdf",
...
# ggsave("field_sal90_heatmap.pdf",
