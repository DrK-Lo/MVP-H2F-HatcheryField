...
This file calculates environmental distance between environment-of-origin sites based on salinity and temperature
(NOT quantiles). The most up to date analysis calculates these distances based on quantiles (envr_dist_quantiles.Rmd).
...
write.csv(envr.df, "../../results/environment/envr_summary_stats.csv")
...
saveRDS(envr.dist.mat, "../../results/environment/envr_dist.rds")
