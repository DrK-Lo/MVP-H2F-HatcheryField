...
raw_LEW <- read.csv("data/environment/Lewisetta/LEW-raw.csv")
...
#write.csv(LEW_temp_full, "data/envr_of_origin/full_temp/LEW_temp_full.csv", row.names = FALSE)

#write.csv(LEW_sal_full, "data/envr_of_origin/full_sal/LEW_sal_full.csv", row.names = FALSE)
```
...
write.table(LEW_temp, "data/environment/all_temperature.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame

# Write to a unique new CSV file
write.csv(LEW_temp, "data/environment/Lewisetta/LEW_temperature.csv")

# Write all montly data to a unique new CSV file
write.csv(LEW_monthly_temp, "data/environment/Lewisetta/LEW_monthly_temp.csv")
...
# Write to the combined file with all sites 
write.table(LEW_salinity, "data/environment/all_salinity.csv", sep = ",", append = TRUE, col.names = FALSE, row.names = FALSE) # The column names should be changed to FALSE after 1st row is added to the data frame

# Write all year data to a unique new CSV file
write.csv(LEW_salinity, "data/environment/Lewisetta/LEW_salinity.csv")
# Write all montly data to a unique new CSV file
write.csv(LEW_monthly_sal, "data/environment/Lewisetta/LEW_monthly_sal.csv")
