...
write.csv(DEBY_temp, "data/environment/S2-DEBY/S2-DEBY_temperature.csv")

# Write all montly data to a unique new CSV file
write.csv(DEBY_monthly_temp, "data/environment/S2-DEBY/S2-DEBY_monthly_temp.csv")
...
write.csv(DEBY_salinity, "data/environment/S2-DEBY/S2-DEBY_salinity.csv")
# Write all monthly data to a unique new CSV file
write.csv(DEBY_monthly_sal, "data/environment/S2-DEBY/S2-DEBY_monthly_sal.csv")
```